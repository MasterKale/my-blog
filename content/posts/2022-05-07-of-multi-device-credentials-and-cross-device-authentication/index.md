...
I hope this helps set the record straight for now. WebAuthn is constantly evolving, and it's only natural that rollouts of new features take time for their capabilities (and implications) to be fully understood. Suffice to say exciting new things are on the horizon for user authentication, and it's just a matter of time before we achieve that passwordless vision for the future.